...
void NeutronLabUHM_MCanalysis_screen5_DD()
{	
	gStyle	->SetOptStat(0);
	gStyle	->SetOptFit(0);
	//gStyle	->SetOptFit(1);
	...
	////////////////////////////////////////////////////////////////////////
	// MC
	const char *DataFolder 	= "/Users/alexkish1/Documents/darkside/GEANT4/NeutronLabUHM/NeutronLabUHM_mod/macros";
	const char *ext  		= ".root";
	const char *outpath     = "./plots";
	const char *extPlots     = ".png";

	//const char *FileName 	= "neutronISO-DD_confine-EmissionPoint_1e5_screen5_moderator-Si_reflector-Pb";
	//const char *FileName 	= "neutronISO-DD_confine-EmissionPoint_1e5_screen6_moderator-Si_reflector-Pb";
	//const char *FileName 	= "DD_generator-10cm_1e6_screen5_moderator-Si_reflector-Pb";
	const char *FileName 	= "DD_generator-10cm_1e6_screen5_moderator-Si_reflector-Pb_window-Li6-2cm";
...
*/	
	...
	Double_t xl1le=.2, yl1le=0.70, xl2le=xl1le+.3, yl2le=yl1le+.175;
	...
	TCanvas *cThetaPhi = new TCanvas("cThetaPhi", "cThetaPhi", 0, 0, 700, 700);
    		 ...
    		 //cr1->SetLogy();
		t1	->	Draw("TMath::ATan2(mY_pre,mZ_pre):TMath::ACos(mX_pre)>>h1_ThetaPhi1", cut_neutron, "COLZ");
	...
	//////////////////////////////////////////////////////////////////////////////////////
	// save plots
	const char *cutname 	= "Screen5_All";
