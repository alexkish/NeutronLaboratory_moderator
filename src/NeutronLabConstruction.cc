...
//	ZeroRot->rotateZ(0. *deg);
	...
	//G4ThreeVector generatorHousingSteel_V	(0.0, 0, 0);
	//G4Transform3D generatorHousingSteel_T	(RotationYPlus90, generatorHousingSteel_V);

	//G4ThreeVector generatorHousingVacuum_V	(0.0, 0, 0);
	//G4Transform3D generatorHousingVacuum_T	(RotationYPlus90, generatorHousingVacuum_V);

	G4double generatorHousingSteel_posX 	= -vault_X/2 + 73*CLHEP::in;
	G4double generatorHousingSteel_posY 	= vault_Y/2 - beamdump_distance - generatorHousing_length/2;
	G4double generatorHousingSteel_posZ 	= -vault_Z/2 + generator_height;

	G4cout <<"Neutron generator position: "<< G4endl;
	G4cout <<"NG X0: "<< generatorHousingSteel_posX *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"NG Y0: "<< generatorHousingSteel_posY *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"NG Z0: "<< generatorHousingSteel_posZ *CLHEP::mm <<" mm"<< G4endl;

	double emissionPoint_X = generatorHousingSteel_posX;
	double emissionPoint_Y = generatorHousingSteel_posY + generatorHousingVacuum_length/2 - 1*CLHEP::cm;
	double emissionPoint_Z = generatorHousingSteel_posZ;
	G4cout <<"Neutron emission point: "<< G4endl;
	G4cout <<"Emission X0: "<< emissionPoint_X *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Emission Y0: "<< emissionPoint_Y *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Emission Z0: "<< emissionPoint_Z *CLHEP::mm <<" mm"<< G4endl;


	////////////////////////////////////////
	// Moderator for DD generator

	// Fe/Si moderator
	double moderator_thick 	 	= 10.*CLHEP::cm;
	double moderator1_length 	= 25.*CLHEP::cm;
	double moderator2_length 	= 18.*CLHEP::cm;

	// Pb/Bi reflector
	double reflector_thick 		= 15.*CLHEP::cm;

	// LiPE
	double protection_thick 	= 10.*CLHEP::cm; 

	// S filter
	double filter1_thick 		= 10.*CLHEP::cm;
	double filter2_thick 		= 6.*CLHEP::cm;
	double filter3_thick 		= 6.*CLHEP::cm;
	double filter_thick 		= filter1_thick + filter2_thick + filter3_thick;

	// Li-6 window to kill thermal neutrons
	double window_thick 		= 5.0*CLHEP::cm;

	// construction from Y- to Y+ (back to front)
	double moderator1_ID 		= generatorHousingSteel_OD;
	double moderator1_OD 		= moderator1_ID + 2*moderator_thick;

	double moderator2_ID 		= 0;
	double moderator2_OD 		= moderator1_OD;
		
	G4Tubs *moderator1			= new G4Tubs("moderator1", moderator1_ID/2, moderator1_OD/2, moderator1_length/2, opendeg, closedeg);	
	G4Tubs *moderator2			= new G4Tubs("moderator2", moderator2_ID/2, moderator2_OD/2, moderator2_length/2, opendeg, closedeg);	

	double moderator1_posX 		= generatorHousingSteel_posX;
	double moderator1_posY 		= generatorHousingSteel_posY + generatorHousingSteel_length/2 - moderator1_length/2;
	double moderator1_posZ 		= generatorHousingSteel_posZ;

	double moderator2_posX 		= generatorHousingSteel_posX;
	double moderator2_posY 		= generatorHousingSteel_posY + generatorHousingSteel_length/2 + moderator2_length/2;
	double moderator2_posZ 		= generatorHousingSteel_posZ;

	double reflector1_length 	= reflector_thick;
	double reflector1_ID		= generatorHousingSteel_OD;
	double reflector1_OD		= moderator1_OD + 2*reflector_thick;
	
	double reflector2_length 	= moderator1_length + moderator2_length + filter1_thick;
	double reflector2_ID		= moderator1_OD;
	double reflector2_OD		= reflector1_OD;
	
	double reflector1_posX		= moderator1_posX;
	double reflector1_posY		= moderator1_posY - moderator1_length/2 - reflector1_length/2;
	double reflector1_posZ		= moderator1_posZ;

	double reflector2_posX		= moderator1_posX;
	double reflector2_posY		= moderator1_posY - moderator1_length/2 + reflector2_length/2;
	double reflector2_posZ		= moderator1_posZ;
	
	G4Tubs *reflector1	= new G4Tubs("reflector1", reflector1_ID/2, reflector1_OD/2, reflector1_length/2, opendeg, closedeg);	
	G4Tubs *reflector2	= new G4Tubs("reflector2", reflector2_ID/2, reflector2_OD/2, reflector2_length/2, opendeg, closedeg);	

	double protection1_length 	= protection_thick;
	double protection1_ID		= 0;
	double protection1_OD		= reflector1_OD + 2*protection_thick;

	double protection2_length 	= generatorHousingSteel_length - moderator1_length - reflector1_length;
	double protection2_ID		= generatorHousingSteel_OD;
	double protection2_OD		= protection1_OD;

	double protection3_length 	= reflector1_length + reflector2_length + filter2_thick;
	double protection3_ID		= reflector1_OD;
	double protection3_OD		= protection1_OD;

	double protection4_length 	= filter3_thick;
	double protection4_ID		= 0;
	double protection4_OD		= protection1_OD;

	G4Tubs *protection1	= new G4Tubs("protection1", protection1_ID/2, protection1_OD/2, protection1_length/2, opendeg, closedeg);	
	G4Tubs *protection2	= new G4Tubs("protection2", protection2_ID/2, protection2_OD/2, protection2_length/2, opendeg, closedeg);	
	G4Tubs *protection3	= new G4Tubs("protection3", protection3_ID/2, protection3_OD/2, protection3_length/2, opendeg, closedeg);	
	G4Tubs *protection4	= new G4Tubs("protection4", protection4_ID/2, protection4_OD/2, protection4_length/2, opendeg, closedeg);	

	double protection1_posX 	= moderator1_posX;
	double protection1_posY 	= generatorHousingSteel_posY - generatorHousingSteel_length/2 - protection1_length/2;
	double protection1_posZ 	= moderator1_posZ;

	double protection2_posX 	= protection1_posX;
	double protection2_posY 	= protection1_posY + protection1_length/2 + protection2_length/2;
	double protection2_posZ 	= protection1_posZ;

	double protection3_posX 	= protection1_posX;
	double protection3_posY 	= protection2_posY + protection2_length/2 + protection3_length/2;
	double protection3_posZ 	= protection1_posZ;

	double protection4_posX 	= protection1_posX;
	double protection4_posY 	= protection3_posY + protection3_length/2 + protection4_length/2;
	double protection4_posZ 	= protection1_posZ;

	double filter1_ID = 0;
	double filter1_OD = moderator1_OD;

	G4Tubs *filter1	= new G4Tubs("filter1", filter1_ID/2, filter1_OD/2, filter1_thick/2, opendeg, closedeg);	
	
	double filter1_posX 		= moderator2_posX;
	double filter1_posY 		= moderator2_posY + moderator2_length/2 + filter1_thick/2;
	double filter1_posZ 		= moderator2_posZ;
	
	double reflector3_length 	= filter2_thick;
	double reflector3_ID 		= 0;
	double reflector3_OD 		= reflector2_OD;

	G4Tubs *reflector3			= new G4Tubs("reflector3", reflector3_ID/2, reflector3_OD/2, reflector3_length/2, opendeg, closedeg);	

	double reflector3_posX		= reflector2_posX;
	double reflector3_posY		= reflector2_posY + reflector2_length/2 + reflector3_length/2;
	double reflector3_posZ		= reflector2_posZ;

	double filter2_IDbot		= 0;
	double filter2_ODbot		= filter1_OD;
	double filter2_IDtop		= 0;
	double filter2_ODtop		= 31*CLHEP::cm;

	G4Cons *filter2 = new G4Cons("filter2", filter2_IDbot/2, filter2_ODbot/2, filter2_IDtop/2, filter2_ODtop/2, filter2_thick/2, opendeg, closedeg);

	double filter2_posX		= 0;
	double filter2_posY		= 0;
	double filter2_posZ		= 0;

	double filter3_IDbot	= 0;
	double filter3_ODbot	= filter2_ODtop;
	double filter3_IDtop	= 0;
	double filter3_ODtop	= 22*CLHEP::cm;

	G4Cons *filter3 = new G4Cons("filter3", filter3_IDbot/2, filter3_ODbot/2, filter3_IDtop/2, filter3_ODtop/2, filter3_thick/2, opendeg, closedeg);

	double filter3_posX		= 0;
	double filter3_posY		= 0;
	double filter3_posZ		= 0;

	// thermal neutron shield
	double window_ID 		= 0;
	double window_OD 		= protection4_OD;
	G4Tubs *window			= new G4Tubs("window", window_ID/2, window_OD/2, window_thick/2, opendeg, closedeg);	

	double window_posX		= protection4_posX;
	double window_posY		= protection4_posY + protection4_length/2 + window_thick/2;
	double window_posZ		= protection4_posZ;
	...
	G4double tunnelBPE_thick 	= 30.0 *CLHEP::cm;
	...
	// screen 5, small screen to test the moderator performance
	G4double screen5_ID 	= 0;
	G4double screen5_OD 	= filter3_ODtop;
	G4double screen5_thick 	= 0.001 *CLHEP::mm;
	G4Tubs *screen5	= new G4Tubs("screen5", screen5_ID/2, screen5_OD/2, screen5_thick/2, opendeg, closedeg);	

	G4cout <<"Screen 5 dimensions: "<< G4endl;
	G4cout <<"Screen 5 ID: "<< screen5_ID *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen 5 OD: "<< screen5_OD *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen 5 thick: "<< screen5_thick *CLHEP::mm <<" mm"<< G4endl;

	G4double screen5_posX 	= window_posX;
	G4double screen5_posY 	= window_posY + window_thick/2 + screen5_thick;
	G4double screen5_posZ 	= window_posZ;
	G4cout <<"Screen 5 position: "<< G4endl;
	G4cout <<"Screen X5: "<< screen5_posX *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen Y5: "<< screen5_posY *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen Z5: "<< screen5_posZ *CLHEP::mm <<" mm"<< G4endl;

	// screen 6, small screen to test the moderator performance WITHOUT WINDOW
	G4double screen6_ID 	= 0;
	G4double screen6_OD 	= filter3_ODtop;
	G4double screen6_thick 	= 0.001 *CLHEP::mm;
	G4Tubs *screen6	= new G4Tubs("screen6", screen6_ID/2, screen6_OD/2, screen6_thick/2, opendeg, closedeg);	

	G4cout <<"Screen 6 dimensions: "<< G4endl;
	G4cout <<"Screen 6 ID: "<< screen6_ID *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen 6 OD: "<< screen6_OD *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen 6 thick: "<< screen6_thick *CLHEP::mm <<" mm"<< G4endl;

	G4double screen6_posX 	= window_posX;
	G4double screen6_posY 	= filter3_posY + filter3_thick/2 + screen5_thick;
	G4double screen6_posZ 	= window_posZ;
	G4cout <<"Screen 6 position: "<< G4endl;
	G4cout <<"Screen X6: "<< screen6_posX *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen Y6: "<< screen6_posY *CLHEP::mm <<" mm"<< G4endl;
	G4cout <<"Screen Z6: "<< screen6_posZ *CLHEP::mm <<" mm"<< G4endl;
	...
	G4LogicalVolume *moderator1_log 				= new G4LogicalVolume(moderator1, 	 			 SiMat, 	"moderator1_log");
	G4LogicalVolume *moderator2_log 				= new G4LogicalVolume(moderator2, 	 			 SiMat, 	"moderator2_log");
	G4LogicalVolume *reflector1_log 				= new G4LogicalVolume(reflector1, 	 			 Lead_mat, 	"reflector1_log");
	G4LogicalVolume *reflector2_log 				= new G4LogicalVolume(reflector2, 	 			 Lead_mat, 	"reflector2_log");
	G4LogicalVolume *reflector3_log 				= new G4LogicalVolume(reflector3, 	 			 Lead_mat, 	"reflector3_log");
	G4LogicalVolume *protection1_log 				= new G4LogicalVolume(protection1, 	 			 LiPE, 		"protection1_log");
	G4LogicalVolume *protection2_log 				= new G4LogicalVolume(protection2, 	 			 LiPE, 		"protection2_log");
	G4LogicalVolume *protection3_log 				= new G4LogicalVolume(protection3, 	 			 LiPE, 		"protection3_log");
	G4LogicalVolume *protection4_log 				= new G4LogicalVolume(protection4, 	 			 LiPE, 		"protection4_log");
	G4LogicalVolume *filter1_log 					= new G4LogicalVolume(filter1, 	 			 	 SMat, 		"filter1_log");
	G4LogicalVolume *filter2_log 					= new G4LogicalVolume(filter2, 	 			 	 SMat, 		"filter2_log");
	G4LogicalVolume *filter3_log 					= new G4LogicalVolume(filter3, 	 			 	 SMat, 		"filter3_log");
	G4LogicalVolume *window_log 					= new G4LogicalVolume(window, 	 			 	 LiMat, 	"window_log");
	...
	G4LogicalVolume *screen5_log  					= new G4LogicalVolume(screen5, 					 Air, 		"screen5_log");
	G4LogicalVolume *screen6_log  					= new G4LogicalVolume(screen5, 					 Air, 		"screen6_log");
	...
	G4PVPlacement *generatorHousingSteel_phys 		= new G4PVPlacement(RotationXPlus90, G4ThreeVector(generatorHousingSteel_posX, generatorHousingSteel_posY, generatorHousingSteel_posZ), generatorHousingSteel_log, "generatorHousingSteel_phys", vault_log, false, 0);
	...
	G4PVPlacement *moderator1_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(moderator1_posX, moderator1_posY, moderator1_posZ), moderator1_log, "moderator1_phys", vault_log, false, 0);
	G4PVPlacement *moderator2_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(moderator2_posX, moderator2_posY, moderator2_posZ), moderator2_log, "moderator2_phys", vault_log, false, 0);
	G4PVPlacement *reflector1_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(reflector1_posX, reflector1_posY, reflector1_posZ), reflector1_log, "reflector1_phys", vault_log, false, 0);
	G4PVPlacement *reflector2_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(reflector2_posX, reflector2_posY, reflector2_posZ), reflector2_log, "reflector2_phys", vault_log, false, 0);
	G4PVPlacement *reflector3_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(reflector3_posX, reflector3_posY, reflector3_posZ), reflector3_log, "reflector3_phys", vault_log, false, 0);
	G4PVPlacement *protection1_phys 		= new G4PVPlacement(RotationXPlus90, G4ThreeVector(protection1_posX, protection1_posY, protection1_posZ), protection1_log, "protection1_phys", vault_log, false, 0);
	G4PVPlacement *protection2_phys 		= new G4PVPlacement(RotationXPlus90, G4ThreeVector(protection2_posX, protection2_posY, protection2_posZ), protection2_log, "protection2_phys", vault_log, false, 0);
	G4PVPlacement *protection3_phys 		= new G4PVPlacement(RotationXPlus90, G4ThreeVector(protection3_posX, protection3_posY, protection3_posZ), protection3_log, "protection3_phys", vault_log, false, 0);
	G4PVPlacement *protection4_phys 		= new G4PVPlacement(RotationXPlus90, G4ThreeVector(protection4_posX, protection4_posY, protection4_posZ), protection4_log, "protection4_phys", vault_log, false, 0);
	G4PVPlacement *filter1_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(filter1_posX, filter1_posY, filter1_posZ), filter1_log, "filter1_phys", vault_log, false, 0);
	G4PVPlacement *filter2_phys 			= new G4PVPlacement(0, G4ThreeVector(filter2_posX, filter2_posY, filter2_posZ), filter2_log, "filter2_phys", reflector3_log, false, 0);
	G4PVPlacement *filter3_phys 			= new G4PVPlacement(0, G4ThreeVector(filter3_posX, filter3_posY, filter3_posZ), filter3_log, "filter3_phys", protection4_log, false, 0);
	G4PVPlacement *window_phys 				= new G4PVPlacement(RotationXPlus90, G4ThreeVector(window_posX, window_posY, window_posZ), window_log, "window_phys", vault_log, false, 0);
	...
	G4PVPlacement *screen5_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(screen5_posX, screen5_posY, screen5_posZ), screen5_log, "screen5_phys", vault_log, false, 0);
	//G4PVPlacement *screen6_phys 			= new G4PVPlacement(RotationXPlus90, G4ThreeVector(screen6_posX, screen6_posY, screen6_posZ), screen6_log, "screen6_phys", vault_log, false, 0);
	...
	window_log					->SetVisAttributes(steel_vis);
	...
	generatorHousingVacuum_log	->SetVisAttributes(PE_vis);
	...
	screen5_log					->SetVisAttributes(screen_vis);
	screen6_log					->SetVisAttributes(screen_vis);
	reflector1_log				->SetVisAttributes(screen_vis);
	reflector2_log				->SetVisAttributes(screen_vis);
	reflector3_log				->SetVisAttributes(screen_vis);
	...
	moderator1_log				->SetVisAttributes(moderator_vis);
	moderator2_log				->SetVisAttributes(moderator_vis);

	G4VisAttributes *protection_vis = new G4VisAttributes(red);
	protection_vis				->SetVisibility(true);
	protection_vis				->SetForceSolid(true);
	protection1_log				->SetVisAttributes(protection_vis);
	protection2_log				->SetVisAttributes(protection_vis);
	protection3_log				->SetVisAttributes(protection_vis);
	protection4_log				->SetVisAttributes(protection_vis);

	G4VisAttributes *filter_vis = new G4VisAttributes(yellow);
	filter_vis				->SetVisibility(true);
	filter_vis				->SetForceSolid(true);
	filter1_log				->SetVisAttributes(filter_vis);
	filter2_log				->SetVisAttributes(filter_vis);
	filter3_log				->SetVisAttributes(filter_vis);

	G4VisAttributes *window_vis = new G4VisAttributes(xlblue);
	window_vis				->SetVisibility(true);
...
*/
	// get mass of the moderator
	G4double mass_moderator = 0.;
	mass_moderator += moderator1_log ->GetMass(false, false)/CLHEP::kg;
	mass_moderator += moderator2_log ->GetMass(false, false)/CLHEP::kg;
	G4cout 	<< "Mass of the moderator:" << mass_moderator << " kg" << G4endl;
	// get mass of the reflector
	G4double mass_reflector = 0.;
	mass_reflector += reflector1_log ->GetMass(false, false)/CLHEP::kg;
	mass_reflector += reflector2_log ->GetMass(false, false)/CLHEP::kg;
	mass_reflector += reflector3_log ->GetMass(false, false)/CLHEP::kg;
	G4cout 	<< "Mass of the reflector:" << mass_reflector << " kg" << G4endl;
	// get mass of the protection
	G4double mass_protection = 0.;
	mass_protection += protection1_log ->GetMass(false, false)/CLHEP::kg;
	mass_protection += protection2_log ->GetMass(false, false)/CLHEP::kg;
	mass_protection += protection3_log ->GetMass(false, false)/CLHEP::kg;
	mass_protection += protection4_log ->GetMass(false, false)/CLHEP::kg;
	G4cout 	<< "Mass of the protection:" << mass_protection << " kg" << G4endl;
	// get mass of the filter
	G4double mass_filter = 0.;
	mass_filter += filter1_log ->GetMass(false, false)/CLHEP::kg;
	mass_filter += filter2_log ->GetMass(false, false)/CLHEP::kg;
	mass_filter += filter3_log ->GetMass(false, false)/CLHEP::kg;
	G4cout 	<< "Mass of the filter:" << mass_filter << " kg" << G4endl;
	// get mass of the window
	G4double mass_window = 0.;
	mass_window += window_log ->GetMass(false, false)/CLHEP::kg;
	G4cout 	<< "Mass of the window:" << mass_window << " kg" << G4endl;
	...
	screen5_log	->SetSensitiveDetector(pScreenSD);
	//screen6_log	->SetSensitiveDetector(pScreenSD);
